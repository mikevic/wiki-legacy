...
<div class="container">
	...
	<div class="row">
		<div class="col-md-2">
			<span class="text-left"><a href="index.php?<?php echo $previous_page_url; ?>">Previous Page</a></span>
		</div>
		<div class="col-md-2 col-md-offset-8 text-right">
			<span class="text-right"><a href="index.php?<?php echo $next_page_url; ?>">Next Page</a></span>
		</div>
